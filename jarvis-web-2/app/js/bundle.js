...
class App {
  constructor() {
    document.body.style.background = 'url("/images/marvel.jpg") no-repeat center center fixed'
...
class Dashboard {
  ...
  getContent() {
    ...
    let deadpoolCard = new __WEBPACK_IMPORTED_MODULE_0__components_card__["a" /* default */]({
      title: 'Deadpool',
    ...
    let wolverineCard = new __WEBPACK_IMPORTED_MODULE_0__components_card__["a" /* default */]({
      title: 'Wolverine',
